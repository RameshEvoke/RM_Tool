        ...
        <tbody className="bg-white">
            ...
            <React.Fragment >
              <tr className="cursor-pointer " >
                <td className="border border-gray-200 text-[#6E7391] text-sm px-3 py-3" onClick={() => handleRowClick(employee.account_name)}> ₹{"200000"}</td>
                <td className="border border-gray-200 text-[#6E7391] text-sm px-3 py-3">₹{"30000"}</td>
                <td className="border border-gray-200 text-[#6E7391] text-sm px-3 py-3">₹{"200000"}</td>
                <td className="border border-gray-200 text-[#6E7391] text-sm px-3 py-3">₹{"100000"}</td>
                <td className="border border-gray-200 text-[#6E7391] text-sm px-3 py-3">₹{"30000"}</td>
                <td className="border border-gray-200 text-[#6E7391] text-sm px-3 py-3">₹{"10000"}</td>
