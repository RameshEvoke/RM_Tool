    ...
    <div className="">
      ...
      <div className="mt-3 mb-2 flex items-center relative justify-content-between">
          ...
          <div className=''>
            ...
            />
            <button className='btn btn-primary py-2 px-3 rounded-0 ml-4'>Add Expense</button>
          </div>
        </div>
          ...
          {currentEmployees.map((employee) => (
            <React.Fragment key={employee.id}>
              <tr className="cursor-pointer " >
                <td className="border border-gray-200 text-[#6E7391] text-sm px-3 py-3" onClick={() => handleRowClick(employee.account_name)}> {employee.account_name}</td>
                <td className="border border-gray-200 text-[#6E7391] text-sm px-3 py-3">{employee.id}</td>
                <td className="border border-gray-200 text-[#6E7391] text-sm px-3 py-3">{employee.account_owner}</td>
                <td className="border border-gray-200 text-[#6E7391] text-sm px-3 py-3">{employee.customer_poc}</td>
                <td className="border border-gray-200 text-[#6E7391] text-sm px-3 py-3">{employee.status}</td>
              </tr>
